...
class WarpBuilder {
    ...
    useWarpGateway(gatewayOptions, cacheOptions) {
        ...
        this._definitionLoader = new WarpGatewayContractDefinitionLoader_1.WarpGatewayContractDefinitionLoader(gatewayOptions.address, this._arweave, contractsCache, this._environment);
        return this;
    }
    useArweaveGateway() {
