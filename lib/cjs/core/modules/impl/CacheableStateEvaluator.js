...
class CacheableStateEvaluator extends DefaultStateEvaluator_1.DefaultStateEvaluator {
    ...
    async eval(executionContext, currentTx) {
        ...
        if (executionContext.handler == null) {
            ...
            return new SortKeyCache_1.SortKeyCacheResult(cachedState == null ? LexicographicalInteractionsSorter_1.genesisSortKey : cachedState.sortKey, new StateEvaluator_1.EvalStateResult(baseState, baseValidity, baseErrorMessages || {}));
        }
