...
exports.LexicographicalInteractionsSorter = exports.lastPossibleKey = exports.genesisSortKey = exports.sortingLast = exports.sortingFirst = void 0;
const utils_1 = require("../../../legacy/utils");
const LoggerFactory_1 = require("../../../logging/LoggerFactory");
const WarpGatewayInteractionsLoader_1 = require("./WarpGatewayInteractionsLoader");
...
exports.lastPossibleKey = `${''.padStart(12, '9')},${lastSortKeyMs},${exports.sortingLast}`;
/**
...
class LexicographicalInteractionsSorter {
    ...
    async addSortKey(txInfo) {
        ...
        if (txInfo.node.sortKey !== undefined && txInfo.node.source == WarpGatewayInteractionsLoader_1.SourceType.WARP_SEQUENCER) {
