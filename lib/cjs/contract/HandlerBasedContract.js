...
class HandlerBasedContract {
    ...
    async createExecutionContext(contractTxId, upToSortKey, forceDefinitionLoad = false, interactions) {
        ...
        const contractEvaluationOptions = this.isRoot()
            ...
            : this.getEoEvaluator().forForeignContract((_c = contractDefinition.manifest) === null || _c === void 0 ? void 0 : _c.evaluationOptions);
        ...
        try {
            ...
            if (e.name == 'ContractError' && e.subtype == 'unsafeClientSkip') {
                if (this.isRoot()) {
                    ...
                    throw new HandlerExecutorFactory_1.ContractError(e.message, e.subtype);
                }
            }
            else {
                throw e;
